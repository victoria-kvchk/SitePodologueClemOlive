# Contenu du site — Clémentine Olive

> **Mode d'emploi :** remplissez les champs marqués `>>>`. Pour les textes, soit vous
> écrivez « OK » (on garde le texte de démonstration déjà en ligne), soit vous collez
> votre propre texte à la place. Une fois rempli, je lis ce fichier **une seule fois**
> et j'intègre tout.
>
> Légende : ✅ = déjà connu / en place · ☐ = à compléter par vous

---

## 1. Infos du cabinet  (à confirmer)

- ✅ **Nom** : Clémentine Olive
- ✅ **Titres** : Pédicure-Podologue D.E · Réflexologue certifiée (école E.T.R.E)
- ✅ **Adresse** : 5 place Denis Papin, 95470 Fosses
- ✅ **Tél. Pédicurie / Podologie** : 06 52 86 09 96
- ✅ **Tél. Réflexologie** : 06 88 41 93 79
- ☐ **E-mail de contact** (optionnel, l'afficher sur le site ?) : >>> Pas de mail
- ☐ **Réseaux sociaux** (Instagram / Facebook, si oui coller les liens) : >>> Pas de réseaux sociaux

## 2. Horaires  (pré-remplis — à confirmer)

- ✅ Lundi : 09h00–12h30 · 13h00–18h30
- ✅ Mardi : 09h30–12h30 · 13h00–17h00
...
- ☐ **Lien Doctolib** (pédicurie + podologie) — URL exacte du profil : >>> https://www.doctolib.fr/pedicure-podologue/fosses/clementine-olive
- ✅ **Google Maps** : carte du cabinet déjà intégrée (chargement au clic, RGPD)
- ☐ **Nom de domaine** prévu (ex. www.clementine-olive.fr) : >>>
...
Format conseillé : JPG, lumière naturelle, ambiance douce. Pour chaque photo, indiquez
si vous l'avez (☐ → ✅) :

- ☐ **Portrait de Clémentine** (accueil + à propos)
- ☐ **Pédicurie** — soin en cabinet
- ☐ **Podologie** — semelles / prise d'empreinte / posture
- ☐ **Réflexologie** — ambiance séance / pieds détente
- ☐ **Cabinet / extérieur** (optionnel, pour la page Contact)
- ☐ **Logo** en version fichier (si vous souhaitez l'afficher dans l'en-tête)
...
- ☐ Souhaitez-vous une section **témoignages / avis** ? (si oui, coller 2–4 avis) : >>>
- ☐ Un **bouton d'appel fixe** en bas d'écran sur mobile ? (oui/non) : >>>
- ☐ Autre remarque : >>>
